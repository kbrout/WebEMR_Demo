        ...
        <div class="col-md-6">
         ...
         <form:form method="POST" id="regForm" modelAttribute="user">
                ...
                First Name:<input type="text" class="form-control" id="exampleInputEmail1" placeholder="First Name"
                  ...
                  <div class="form-group">
                Last Name:<input type="text" class="form-control" id="exampleInputPassword1"
                            placeholder="Last Name" required name="lastname">
                  </div>
                   <div class="form-group">
                User Name:<input type="text" class="form-control" id="exampleInputPassword1"
                ...
                Password:<input type="password" class="form-control" id="exampleInputPassword1"
                   ...
                   <div class="form-group">
                Email:<input type="email" class="form-control" id="exampleInputPassword1"
