...
INSERT INTO user (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (4, 'user', '$2y$12$2e.Mny8OjdHvpnsU2daQqehR4Y/AkmJgD4lA84YV//vji5wqd26yi', 'chandan', 'rout', 'chandan@gmail.com', 1, STR_TO_DATE('01/01/2016','%c/%e/%Y %r'));
